package com.example.tools_kazakov;
...
public class ExampleInstrumentedTest {
    ...
    public void A_UserLogin() throws InterruptedException {
        ...
        new UserLogin(User, new MyResponseCallback() {
            @Override
    ...
    public void B_UserCreate() throws InterruptedException {
        ...
        new UserCreate(User, new MyResponseCallback() {
            @Override
            public void onCompile(String result) {
    ...
    public void C_UserUpdate() throws InterruptedException {
        ...
        new UserUpdate(User, CURRENT_TOKEN, new MyResponseCallback() {
            @Override
            public void onCompile(String result) {
    ...
    public void D_UserGet() throws InterruptedException {
        ...
        new UserGet(CURRENT_TOKEN, new MyResponseCallback() {
            @Override
            public void onCompile(String result) {
    ...
    public void E_UserLogout() throws InterruptedException {
        ...
        new UserLogout(CURRENT_TOKEN, new MyResponseCallback() {
            @Override
            public void onCompile(String result) {
    ...
    public void F_UserSend() throws InterruptedException {
        ...
        new UserSend("testing@mail.ru", new MyResponseCallback() {
            @Override
            public void onCompile(String result) {
